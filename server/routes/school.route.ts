...
import { createSchool, getAllSchools, getSchoolById, removeTeacherFromTheSchool, updateSchoolClasses, updateSchoolTeachers } from '../contorllers/school.controller';
...
router.put('/remove-teacher-from-school', checkUser, checkRole("admin", "teacher"), removeTeacherFromTheSchool);
