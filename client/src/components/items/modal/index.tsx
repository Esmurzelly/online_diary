...
const Modal = ({ showModal, setShowModal, tokenValue, handleLogOut }: Props) => {
    ...
    return (
        <div className={`absolute font-inter text-secondary-light text-center h-screen top-0 ${showModal ? '-translate-x-10' : "-translate-x-full"} transition-all w-full min-h-svh z-20 py-1! bg-primary-dark`}>
